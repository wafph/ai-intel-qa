...
const startStream = async () => {
  try {
    ...
    const response = await fetch(
      '/api1/v1/1725c43e3fa54828a078fce60f5a3773/agents/52512531-0a97-480f-bd5c-5f4fd0df61c4/conversations/3aa41dc6-0427-4b0a-b29c-1b512d2eaf56?version=1775061446109',
      {
        method: 'post',
        headers: {
