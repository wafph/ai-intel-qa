...
const startStream = async () => {
  try {
    ...
    const response = await fetch(
      'api1/v1/1725c43e3fa54828a078fce60f5a3773/agents/37fc417e-982b-413d-a9cb-a86e08f45cbb/conversations/dd73b80e-efeb-4991-8b9d-f581f41c36d9?version=1774405492195',
      {
        method: 'post',
        headers: {
